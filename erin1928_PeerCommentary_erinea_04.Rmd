...
##COMMENT: To display the function I used g <- g + geom_smooth(method = "lm", formula = y ~ x) + stat_regline_equation(label.x=30, label.y=310) + stat_cor(aes(label=..rr.label..), label.x=30, label.y=290) with the package ggpubr. The firss "label" denotes where on the graph you want your equation to be located, change as necessary. The second half gives you the R^2 value of the regression model, again, using the label function to place it as you like on the graph. This part isn't strictly necessary, but I found it on the same website and might be good to keep in your repetoir :)
